...
selectedNavbar=option_menu(menu_title=None,options=["Home","Highlights","Results","Contact-Us","Hall of Fame","Faqs"],orientation="horizontal",default_index=0,styles={
...
if selectedNavbar =="Highlights":
    ...
    st.title("Highlights of the Match")
    ...
    with st.sidebar:
        st.sidebar.header("Watch The Highlights Here")
